...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let cy = other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2];
    ...
    magnitude() {
        // Insert your code here.
        let x = this.elements[0], y = this.elements[1], z = this.elements[2];// Modify this line to calculate this vector's magnitude.
